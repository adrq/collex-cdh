...
class Solr
	 ...
	 def initialize(core)
      ...
      if core == "pages"
         ...
         @facet_fields = ['genre','archive','freeculture', 'has_full_text', 'federation', 'typewright', 'doc_type', 'discipline', 'role','origin','language','composition'] # origin,composition and language field added for the facets to be shown in the search field.'--- akhil
      end
   end
