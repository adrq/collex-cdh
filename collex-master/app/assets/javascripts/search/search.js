...
window.collex.generalFacets('Origin');
}else if(newQueryKey == "provenance"){
window.collex.generalFacets('Provenance');
window.collex.generalFacets('Provenance');
...
window.collex.generalFacets('Genre');
}else if(newQueryKey == "lang"){
window.collex.generalFacets('Language');
window.collex.generalFacets('Language');
}else{
window.collex.generalFacets('Access');
window.collex.generalFacets('Access');
}
}else if (action === 'add'){
